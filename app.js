...
const App = (() => {
    ...
    function openArticleModal(article) {
        ...
        if (date) date.textContent = fmtDate(article.createdAt || Date.now());
    ...
    function renderArticles(articles) {
      ...
      <div class="glass-card article-card animate-on-scroll" onclick="App.readArticle(${art.id})">
        ...
        <div class="art-body">
          <div class="art-meta">
            <span class="art-date">${fmtDate(art.createdAt || Date.now())}</span>
    ...
    async function playSong(id) {
        ...
        if (!song) song = await CMS.Songs.get(id);
